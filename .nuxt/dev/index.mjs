globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, createError, getQuery } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/h3/dist/index.mjs';
import { Configuration, OpenAIApi } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/openai/dist/index.js';
import { createRenderer } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/node_modules/radix3/dist/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{},"OPENAI_API_KEY":""};
...
const serverAssets = [{"baseName":"server","dir":"D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Programming\\FrontEnd\\Vuejs\\chat-gpt\\ai-chatbot-course","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Programming\\FrontEnd\\Vuejs\\chat-gpt\\ai-chatbot-course\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Programming\\FrontEnd\\Vuejs\\chat-gpt\\ai-chatbot-course\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Programming\\FrontEnd\\Vuejs\\chat-gpt\\ai-chatbot-course\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_gHP993 = () => Promise.resolve().then(function () { return ai_post$1; });
const _lazy_eGukGN = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/ai', handler: _lazy_gHP993, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_eGukGN, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_eGukGN, lazy: true, middleware: false, method: undefined }
];
...
const ai_post$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: ai_post
});
...
const getClientManifest = () => import('file://D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
