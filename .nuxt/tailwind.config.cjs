module.exports = {
  ...
  "content": {
    "relative": false,
    "files": [
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/components/**/*.{vue,js,ts}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/layouts/**/*.vue",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/pages/**/*.vue",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/composables/**/*.{js,ts}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/plugins/**/*.{js,ts}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/utils/**/*.{js,ts}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/App.{js,ts,vue}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/app.{js,ts,vue}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/Error.{js,ts,vue}",
      "D:/Programming/FrontEnd/Vuejs/chat-gpt/ai-chatbot-course/error.{js,ts,vue}"
    ],
    "extract": {},
    "transform": {}
